...
class SmsService
{
    ...
    {
        $this->africasTalkingUsername = config("app.AfricasTalking_Username");
        $this->africasTalkingApiKey = config("app.AfricasTalking_ApiKey");
    }
    ...
    public function sendMessage($phone_number, $message)
    {
        try {
            ...
            // dd($this->africasTalkingUsername, $this->africasTalkingApiKey);
